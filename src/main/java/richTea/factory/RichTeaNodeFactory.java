...
import richTea.impl.BootstrapBinding;
import richTea.impl.ImportNode;
import richTea.impl.VariableReferenceFunction;
...
public class RichTeaNodeFactory {
	...
	protected Binding createFunctionReferenceBinding(NodeData nodeData) {
		return new BootstrapBinding(nodeData.getName(), TreeNode.class, VariableReferenceFunction.class);
	}
